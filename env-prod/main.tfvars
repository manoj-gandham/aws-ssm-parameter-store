parameters = [
  { name = "prod.frontend.catalogue_url", value = "http://catalogue-prod.mdevops333.shop:80/" },
  { name = "prod.frontend.cart_url", value = "http://cart-prod.mdevops333.shop:80/" },
  { name = "prod.frontend.user_url", value = "http://user-prod.mdevops333.shop:80/" },
  { name = "prod.frontend.shipping_url", value = "http://shipping-prod.mdevops333.shop:80/" },
  { name = "prod.frontend.payment_url", value = "http://payment-prod.mdevops333.shop:80/" },
  { name = "prod.catalogue.mongo_endpoint", value = "mongodb-prod.mdevops333.shop" },
  ...
  { name = "prod.user.mongo_endpoint", value = "mongodb-prod.mdevops333.shop" },
  { name = "prod.cart.redis_host", value = "elasticache-prod-elasticache.xnr0mx.ng.0001.use1.cache.amazonaws.com" },
  { name = "prod.cart.catalogue_host", value = "catalogue-prod.mdevops333.shop" },
  { name = "prod.cart.catalogue_port", value = "80" },
  { name = "prod.shipping.cart_endpoint", value = "cart-prod.mdevops333.shop:80" },
  ...
  { name = "prod.payment.cart_host", value = "cart-prod.mdevops333.shop" },
  { name = "prod.payment.cart_port", value = "80" },
  { name = "prod.payment.user_host", value = "user-prod.mdevops333.shop" },
  { name = "prod.payment.user_port", value = "80" },
  { name = "prod.payment.amqp_host", value = "rabbitmq-prod.mdevops333.shop" },
