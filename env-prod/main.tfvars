parameters = [
  ...
  { name = "prod.user.redis_host", value = "elasticache-dev-elasticache.xnr0mx.ng.0001.use1.cache.amazonaws.com" },
  { name = "prod.user.mongo_endpoint", value = "mongodb-prod.mdevops333.online" },
  { name = "prod.cart.redis_host", value = "elasticache-dev-elasticache.xnr0mx.ng.0001.use1.cache.amazonaws.com" },
  ...
  { name = "prod.rds.db_host", value = "rds-dev-rds.cluster-cxy44muc01d4.us-east-1.rds.amazonaws.com" },
